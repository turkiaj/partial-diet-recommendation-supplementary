...
transformed parameters {
  ...
  matrix[k, k] Lamnda;            // Tau * Cholesky decomposition
  ...
  // diag(sigma_b) * L
  Lamnda = diag_pre_multiply(sigma_b, L); 
...
model { 
  ...
  for (n in 1:N) 
  {
     mu = beta_Intercept + offset + X_t[n] * beta + Z_t[n] * b[group[n]];
