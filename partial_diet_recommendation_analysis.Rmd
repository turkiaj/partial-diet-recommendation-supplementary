...
```{r graph_with_gamma_qr_mv_epros_prep, echo=FALSE}
initial_graph <- mebn.fully_connected_bipartite_graph(datadesc_fat_epros)
...
kable(two_level_effects_table.df[1:33,c(3:4,5,8:16)], "latex", escape = F, booktabs = T, row.names = FALSE, digits = 2,align="llccccccccccc",
  caption = "Estimated effects of nutrition in general and dialysis treatment levels, and in personal level within the same treatment.",
  col.names = c("Nutrient", "Conc.", "General effect", "avg", "min", "max", "avg", "min", "max", "avg", "min", "max")) %>%
  column_spec(1, width = "7em") %>%
  column_spec(2, width = "4em") %>%
  column_spec(4, bold=TRUE) %>%
  ...
  save_kable(file = "tables/variation_of_nutrition_effects1.pdf", keep_tex = TRUE)

kable(two_level_effects_table.df[34:66,c(3:4,5,8:16)], "latex", escape = F, booktabs = T, row.names = FALSE, digits = 2,align="llccccccccccc",
  caption = "Estimated effects of nutrition in general and dialysis treatment levels, and in personal level within the same treatment (table continues).",
  col.names = c("Nutrient", "Conc.", "General effect", "avg", "min", "max", "avg", "min", "max", "avg", "min", "max")) %>%
  column_spec(1, width = "7em") %>%
  column_spec(2, width = "4em") %>%
  column_spec(4, bold=TRUE) %>%
...
```
```{r full_effects_table2, eval=TRUE, include=TRUE, fig.align="center", fig.width=8, echo=FALSE}
knitr::include_graphics("tables/variation_of_nutrition_effects1.pdf")
```

```{r full_effects_table3, eval=TRUE, include=TRUE, fig.align="center", fig.width=8, echo=FALSE}
