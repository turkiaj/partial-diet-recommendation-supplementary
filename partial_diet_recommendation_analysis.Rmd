  ...
  if (file.exists(accepted_intake)) {
    ...
    else
    {
      ...
      fppi_plot <- ggplot(concs_minmax.df, aes(x = fppi, group=factor(color_order))) +
        ...
        scale_x_continuous(breaks=c(fppi_recommendations,c(0,1,2,3)), limits = c(fppi_recommendations,c(0,1,2,3))) +
        scale_colour_manual(values = MyPalette) +
      ...
      palb_plot <- ggplot(concs_minmax.df, aes(x = palb, color=factor(color_order), group=factor(color_order))) +
        geom_density(aes(color=factor(color_order)),rel_min_height = 0.01, show.legend = FALSE) +
        ...
        scale_x_continuous(breaks=c(palb_recommendations,30,40,50), limits = c(palb_recommendations,30,40,50)) +
        scale_colour_manual(values = MyPalette) +
