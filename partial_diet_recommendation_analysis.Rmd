...
```{r, effect_correlation_plot, fig.width=14, fig.out="100%", fig.align="left", eval=TRUE, cache=FALSE, echo=FALSE}
library(ggcorrplot)
...
```{r, include=TRUE, fig.align="center", fig.cap=c("Correlation plot of matrix $C$ that includes the estimated within-model and cross-model correlations of personal effects"), echo=FALSE}
...
# variations removed 
kable(two_level_effects_table.df[c(3:4,5,8:16)], "latex", escape = T, booktabs = T, row.names = FALSE, digits = 2,align="llccccccccccc",
  caption = "Variation of nutrition effects between different dialysis treatments and between patients within the same treatment.",
  col.names = c("Nutrient", "Conc.", "General effect", "avg", "min", "max", "avg", "min", "max", "avg", "min", "max")) %>%
  column_spec(1, width = "7em") %>%
  column_spec(2, width = "4em") %>%
