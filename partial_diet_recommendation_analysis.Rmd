...
```{r dialysis_gamma_mv_cross_2levels_ppc, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, cache=TRUE, fig.cap="In this model the three concentrations and their parameters are stacked into one univariate model for estimating cross-model correlations."}
dialysis_imputed <- readRDS("data/DIALYSIS_imputed_palb.rds")
pk_fppi_palb_targets <- datadesc_fat_epros[datadesc_fat_epros$Name %in% c('pk','fppi','palb'),]
