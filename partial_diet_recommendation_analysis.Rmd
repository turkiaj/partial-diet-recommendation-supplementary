...
graph_dir <- "graphs/mv3_cross_two_levels/effect_point_est_mode/"
...
for (person_id in 10:10) {
  ...
  personal_graph <- mebn.extract_multilevel_graph(person_id, group_id, initial_graph, personal_model_dir, assumedpredictors, assumedtargets, latent_parameter_modeldir, personal_data, personal_data_org, personal_concentrations_org, datadesc, effect_point_est = "mode")
